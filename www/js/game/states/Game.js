...
myRunner.Game.prototype = {
    ...
    groundHit: function (player, ground) {
        ...
        //uncomment it and comment above line if you wanna create a game where there are only coins and 
        //if player touches the ground he fails. Also dont forget to comment all enemies and remove enemy.js
        //this.game.state.start('MainMenu');
        //Also we can create a different game state
        
    },

    createCoin: function () {
        var x = this.game.width;
        var y = this.game.rnd.integerInRange(20, this.game.world.height - 132);
    ...
    coinHit: function (player, coin) {
        ...
        //Add it as a Part of next upgrade
    ...
    enemyHit: function (player, enemy) {
        //uncomment this if you wanna just start the game from beginning when u die 
        //this.game.state.start('MainMenu');
        //uncomment this if you wanna just right away start the game 
